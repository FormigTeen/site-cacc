                    ...
                    @foreach($eventos as $event)
                        <div class="swiper-slide">
                            <div class="event row align-items-center align-items-stretch">
                                <div class="col-lg-12 col-sm-6 pr-lg-0">
                                ...
                                <div class="col-lg-12 col-sm-6 pl-lg-0">
...
<section style="background: url(img/divider-bg.jpg) fixed;" class="divider has-overlay-darker">
    <div class="container">
        ...
        <div class="CTAs"><a href="{{ $page->bot_url }}" target="_blank" class="btn btn-primary"><i class="fa fa-telegram"></i> Conversar com o Bot</a></div>
    </div>
</section>
